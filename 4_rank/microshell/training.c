...
// 3. Função para escrever uma mensagem de erro no erro padrão (descritor de arquivo 2)


// 4. Função (cd) para alterar o diretório atual
// cd deve estar na posicao argv[1]


// 5. Função (exec) para executar um comando
